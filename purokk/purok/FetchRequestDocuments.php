...
function getDocumentsData($conn) {
    $sql = "SELECT id, resident_id, FullName, document_type, reason, is_confirmed,Payment, created_at FROM request_documents WHERE visibility_flag = 'requestvisible' AND is_confirmed = 'unconfirm'";
